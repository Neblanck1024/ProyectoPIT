    ...
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.UseFacebookAuthentication(
               appId: "2439176129692779",
               appSecret: "085231d790a7c2032424999d30a3ba90");

            app.UseGoogleAuthentication(new GoogleOAuth2AuthenticationOptions()
            {
                ClientId = "682352458618-4840cklsdbc56jt7qj3glp0e63qfpfi1.apps.googleusercontent.com",
                ClientSecret = "wO_JrNdp935bYcxcTT3zlEMO"
            });
        }
    }
}